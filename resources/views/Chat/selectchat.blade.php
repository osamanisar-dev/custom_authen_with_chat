...
{{--                                </li>--}}
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-xs-9">
                            <input style="display:none;" class="form-control sender-id" value={{session('user')->id}}>
                            <input style="display: none" class="form-control user-id" value="{{$user->id}}">
                            <input type="text" placeholder="Enter your text" class="form-control chat-input user-message">
                        </div>
                        <div class="col-xs-3">
