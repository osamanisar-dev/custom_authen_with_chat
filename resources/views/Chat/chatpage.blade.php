        ...
        <div class="col-md-10">
            <div class="list-group">
                @foreach($users as $user)
                    <div style="margin: 10px;border-radius: 10%;box-shadow: 0px 3px 8px rgba(0, 0, 0, 0.1);" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                        <div>
